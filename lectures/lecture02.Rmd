...
- there is at least one scientific journal that has banned the use of pp-values!
...
- The book Statistical Principles for the Design of Experiments [@Mead2012] goes into more depth, especially in relation to calculation procedures for many 'classical' designs.
